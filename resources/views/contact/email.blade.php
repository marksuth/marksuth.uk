                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                                                        <div>
                                                                                            <h1 class="" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px;" align="left">New Website Enquiry</h1>
                                                                                            ...
                                                                                            <table class="btn btn-primary " border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px;">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center" bgcolor="#eb002b">
                                                                                                            <a href="mailto:{{ $email }}" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #eb002b; color: #ffffff; padding: 8px 12px; border: 1px solid #eb002b;">Respond</a>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                            ...
                                                                                            <p class="text-muted" style="line-height: 24px; font-size: 16px; width: 100%; color: #636c72; margin: 0;" align="left">Email sent via marksuth.dev/contact</p>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
